...
SWEP.Trivia_Desc		= "Russian semi-automatic handgun. Cheaply produced en masse, but its small single-stack magazine leaves it in poor standing against more girthy rivals."
SWEP.Slot				= 1
...
SWEP.AttachmentElements = {
	["weapon"] = {
		VMElements = {
			{
				Model = "models/weapons/w_pist_pmt.mdl",
				Bone = "j_gun",
				Offset = {
					pos = Vector(-1, 0, -3.9),
					ang = Angle(0, 0, 0),
