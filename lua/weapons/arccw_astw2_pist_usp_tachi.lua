...
SWEP.Trivia_Desc		= "Japanese-made silenced 9mm handgun, designed as a modified USP. Differences include a smaller chambering and integral suppressor, which reduces the bullet's velocity to subsonic levels."
SWEP.Slot				= 1
