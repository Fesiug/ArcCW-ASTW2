...
SWEP.Trivia_Desc		= "Iconic .50 AE heavy pistol. Popular in movies and video games for its flashy nature, but prone to jamming. Its 7-round magazine also leaves much to desire. This pistol is gold-plated for extreme bling factor."
SWEP.Slot				= 1
...
SWEP.AttachmentElements = {
	["weapon"] = {
		VMElements = {
			{
				Model = "models/weapons/w_pist_deagle_gold.mdl",
				Bone = "j_gun",
				Offset = {
