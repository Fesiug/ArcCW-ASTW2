...
SWEP.Trivia_Desc		= "Czech compact SMG in .32 ACP. An unusual design with a wire stock and grip-embedded magazine. While it superficially resembles the M-11, it has nothing to do with it. Small enough to fit in most pistol holsters."
SWEP.Slot				= 1
...
SWEP.AttachmentElements = {
	["weapon"] = {
		VMElements = {
			{
				Model = "models/weapons/w_smg_zbr08.mdl",
				Bone = "j_gun",
				Offset = {
					pos = Vector(-1, 0, -3.8),
					ang = Angle(0, 0, 0),
...
--		MinProgress = 1.2,
		SoundTable = {
			{ s = "weapons/tmp/tmp_clipout.wav",			t = 0.1 },
			{ s = "weapons/tmp/tmp_clipin.wav",				t = 0.6 },
		},
		LHIK = true,
		LHIKIn = 0.25,
		LHIKOut = 0.25,
...
--		MinProgress = 1.2,
		SoundTable = {
			{ s = "weapons/tmp/tmp_clipout.wav",			t = 0.1 },
			{ s = "weapons/tmp/tmp_clipin.wav",				t = 0.6 },
			{ s = "weapons/mac10/mac10_boltpull.wav",			t = 1.3 },
		},
		LHIK = true,
		LHIKIn = 0.25,
		LHIKOut = 0.25,
