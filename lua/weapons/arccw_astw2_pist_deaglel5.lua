...
SWEP.Trivia_Desc		= ".44 magnum pistol, fitted with an integral muzzle break, cut down internally and externally to reduce its weight, and loaded with 12 round magazines."
SWEP.Slot				= 1
...
-- -- -- -- World
SWEP.WorldModel			= "models/weapons/w_pist_deagle_l5_2.mdl"
...
SWEP.ShootVol			= 85
SWEP.ShootPitch			= 100
SWEP.ShootSound			= "weapons/deagle/l5-1.wav"
...
SWEP.AttachmentElements = {
	["weapon"] = {
		VMElements = {
			{
				Model = "models/weapons/w_pist_deagle_l5_2.mdl",
				Bone = "j_gun",
				Offset = {
...
--		MinProgress = 1.2,
		SoundTable = {
			{ s = "weapons/deagle/de_clipout.wav",			t = 0.1 },
			{ s = "weapons/deagle/de_clipin.wav",				t = 0.6 },
