...
SWEP.Trivia_Desc		= "3-round-burst version of the M9. A foregrip improves controllability."
SWEP.Slot				= 1
...
-- -- -- -- World
SWEP.WorldModel			= "models/weapons/arccw/astw2/worldmodels/w_smg_m93r.mdl"
...
SWEP.AttachmentElements = {
	["weapon"] = {
		VMElements = {
			{
				Model = "models/weapons/arccw/astw2/worldmodels/w_smg_m93r.mdl",
				Bone = "j_gun",
				Offset = {
					pos = Vector(-1, 0, -4),
					ang = Angle(0, 0, 0),
