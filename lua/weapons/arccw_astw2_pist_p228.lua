...
SWEP.Trivia_Desc		= "Self-loading semiautomatic pistol produced by the SIG SAUER company."
SWEP.Slot				= 1
...
--		MinProgress = 1.2,
		SoundTable = {
			{ s = "weapons/p228/p228_clipout.wav",			t = 0.1 },
...
--		MinProgress = 1.2,
		SoundTable = {
			{ s = "weapons/p228/p228_clipout.wav",			t = 0.1 },
			{ s = "weapons/usp/usp_clipin.wav",				t = 0.6 },
			{ s = "weapons/p228/p228_sliderelease.wav",			t = 1.3 },
		},
		LHIK = true,
		LHIKIn = 0.25,
		LHIKOut = 0.5,
