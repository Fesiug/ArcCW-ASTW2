...
SWEP.Trivia_Desc		= "Italian 9mm handgun, the 'little brother' of the FS."
SWEP.Slot				= 1
...
-- -- -- -- World
SWEP.WorldModel			= "models/weapons/arccw/astw2/worldmodels/w_smg_m92g.mdl"
...
-- -- -- -- Weapon control
SWEP.Recoil			= 0.5--6
SWEP.RecoilSide		= 0.25--3

SWEP.ASTW2Accuracy      = 1/40--50 
...
SWEP.AttachmentElements = {
	["weapon"] = {
		VMElements = {
			{
				Model = "models/weapons/arccw/astw2/worldmodels/w_smg_m92g.mdl",
				Bone = "j_gun",
				Offset = {
					pos = Vector(-1, 0, -4),
					ang = Angle(0, 0, 0),
